...
if DC1
    set(instr.dc1, 'Voltage', BIAS.V1(1));
    set(instr.dc1, 'Current', BIAS.I1(1));
    set(instr.dc1, 'Output', 1);
end
if DC2
    set(instr.dc2, 'Voltage', BIAS.V2(1));
    set(instr.dc2, 'Current', BIAS.I2(1));
